...
**Result:** False. 
Random Forest (0.9946 AUC) outperformed the best standard GNN (0.8699 AUC) by 12.5%.  
...
**Result:** False. 
Ablation studies proved these features contributed zero predictive power.  
...
**Result:** False.
FPs only reduced to 2,995, and the F1 score remained abysmal (0.367).  
